...
const memberService = {
    ...
    */
    ...
    friend_delete_confirm: async (req, res) => {
        ...
        let deleteFriendSql = `
            ...
            OR 
                (F_OWNER_ID = ? AND F_ID = ?)
        `;
        printLog(DEFAULT_NAME, 'friend_delete_confirm3');
    ...
    get_friend_status: (req, res) => {
        ...
        printLog(DEFAULT_NAME, 'get_friend_status() post.f_id', post.f_id);
        printLog(DEFAULT_NAME, 'get_friend_status() m_id', m_id);
        ...
        `, [m_id, post.f_id], (err, result) => {
            ...
            // 친구인 경우
            if (result.length > 0) {
                printLog(DEFAULT_NAME, 'get_friend_status friend ok');
                ...
                `, [m_id, post.f_id], (err2, result2) => {
                    ...
                    // 친구는 아닌데 친구 요청한 경우
                    if(result2.length > 0) {
                        printLog(DEFAULT_NAME, 'get_friend_status friend ing');
                    ...
                    // 친구도 아니고 친구 요청도 안한 경우
                        ...
                        printLog(DEFAULT_NAME, 'get_friend_status friend x');
